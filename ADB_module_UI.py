...
"")
        ...
        self.formLayout = QtWidgets.QFormLayout(self.ADB)
        ...
        self.verticalLayout_4.addWidget(self.close)
        self.adb_operation = QtWidgets.QPushButton(self.ADB)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.adb_operation.sizePolicy().hasHeightForWidth())
        self.adb_operation.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Franklin Gothic Medium")
        font.setPointSize(12)
        self.adb_operation.setFont(font)
        self.adb_operation.setDefault(True)
        self.adb_operation.setObjectName("adb_operation")
        self.verticalLayout_4.addWidget(self.adb_operation)
        ...
        self.verticalLayout_4.addWidget(self.adb_cpu_info)
        ...
        self.verticalLayout_4.addWidget(self.get_screenshot)
        ...
        self.verticalLayout_4.addWidget(self.input_text_via_adb)
        ...
        self.verticalLayout_4.addWidget(self.pull_log_without_clear)
        ...
        self.verticalLayout_4.addWidget(self.pull_log_with_clear)
        ...
        self.verticalLayout_4.addWidget(self.clear_app_cache)
        ...
        self.verticalLayout_4.addWidget(self.force_stop_app)
        self.gridLayout_3.addLayout(self.verticalLayout_4, 5, 2, 1, 1)
        ...
        self.install_system = QtWidgets.QPushButton(self.ADB)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.install_system.sizePolicy().hasHeightForWidth())
        self.install_system.setSizePolicy(sizePolicy)
        self.install_system.setObjectName("install_system")
        self.gridLayout_2.addWidget(self.install_system, 12, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.start_app, 14, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.adb_uninstall, 13, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.adb_operation.setText(_translate("MainWindow", "显示设备号"))
        self.adb_cpu_info.setText(_translate("MainWindow", "显示CPU信息"))
        self.get_screenshot.setText(_translate("MainWindow", "截屏"))
        ...
        self.install_system.setToolTip(_translate("MainWindow", "<html><head/><body><p>根据选择的apk的包名查找设备中该包名应用的安装目录并推送</p></body></html>"))
        self.install_system.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>根据选择的apk的包名查找设备中该包名应用的安装目录并推送</p></body></html>"))
        self.install_system.setText(_translate("MainWindow", "Push apk"))
